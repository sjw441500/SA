...
def get_cluster_number(dataset):
    ...
    scores = []
    slop=[]
    X,vectorizer = transform(dataset,n_features=500,stopwords='english')
...
def draw_cluster_totle(sum_of_article, numb):
    ...
    plt.savefig('./images/cluster_show_eg.png')
...
write_xls("./xls/input.xls",0,1,1,result)

write_xls("./xls/input.xls",0,1,2,keywords)
...
write_xls("./xls/input.xls",0,0,1,numb)
write_xls("./xls/input.xls",0,1,3,sum_of_article)
write_xls("./xls/input.xls",0,1,4,percent_of_article)
